...
public class DocSpaceController {
  ...
  @Audit(action = "doc-space-create", objectType = "docSpace")
  ...
  @Audit(action = "doc-space-update", objectType = "docSpace")
  @AuditDiff(objectType = "docSpace")
  ...
  @DeleteMapping("/doc-spaces/{docSpaceId}")
  @Operation(operationId = "deleteDocSpace")
  @RequirePrivilege("doc-space-delete")
  @Audit(action = "doc-space-delete", objectType = "docSpace")
  @AuditDiff(objectType = "docSpace")
